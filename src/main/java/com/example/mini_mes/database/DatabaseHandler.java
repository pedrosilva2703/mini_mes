...
public class DatabaseHandler {
    ...
    public void updatePieceStatus(int id, String new_status){
        String sql =    "UPDATE piece \n" +
                "SET status = ?\n" +
                "WHERE id=?\n";
        try {
    ...
    public ArrayList<Piece> getInboundPiecesHistory(int current_week){
        String sql =    "SELECT  piece.id,\n" +
                "        supplier_order.type,\n" +
                "        piece.status,\n" +
                "        piece.final_type,\n" +
    ...
    public ArrayList<Piece> getProductionPiecesHistory(int current_week){
        String sql =    "SELECT  piece.id,\n" +
                "        supplier_order.type,\n" +
                "        piece.status,\n" +
                "        piece.final_type,\n" +
    ...
    public ArrayList<Piece> getExpeditionPiecesHistory(int current_week){
        String sql =    "SELECT  piece.id,\n" +
                "        piece.type,\n" +
                "        piece.status,\n" +
                "        piece.final_type,\n" +
        ...
        try {
            ...
            while (sqlReturnValues.next()){
                ...
                String supplier = sqlReturnValues.getString(11);
                p.setSupplier(supplier);
                int expedition_week = sqlReturnValues.getInt(12);
                p.setWeek_shipped(expedition_week);
